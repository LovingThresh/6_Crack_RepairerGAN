...
hyper_params = {
    ...
    'datasets_dir': '../2_datasets/crack_datasets',
    'load_size': 224,
    'crop_size': 224,
    'batch_size': 2,
    'epochs': 5,
...
if hyper_params['device'] == 'A40':
    ...
    repeat_num = 2
elif hyper_params['device'] == '3080Ti' or '3090' or '4090':
...
def train_G(A_True, B_True):
    with tf.GradientTape() as t:
        ...
        A2B_Attention = G_A2B(A_True, training=True)[1]
        ...
        Perceptual_loss_1 = perceptual_loss(A2B_Fake, B_True)
        Perceptual_loss_2 = perceptual_loss(B2A2B_Fake, B_True)
        Perceptual_loss_3 = perceptual_loss(B2B, B_True)
